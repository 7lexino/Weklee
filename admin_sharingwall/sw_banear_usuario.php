...
if($_POST){
    if($_POST["id_us_b"]==""){
        ...
        <a href="./?sw_administracion=baneos" class="style4">Volver a Administracion de Baneos!</a>
        </div>';
    }elseif($_POST["motivo_ban"]==""){
        //== SI EL CAMPO REPORTE_POST ESTA VACIO MOSTRAMOS LO SIGUIENTE ==//
        echo '<div class="ws10" align="left">
        No has puesto ningun MOTIVO para Banear el USUARIO!<p>
        <a href="./?sw_administracion=baneos" class="style4">Volver a Administracion de Baneos!</a>
        </div>';
    }elseif($_POST["fecha_de_ban"]==""){
        //== SI EL CAMPO REPORTE_POST ESTA VACIO MOSTRAMOS LO SIGUIENTE ==//
        echo '<div class="ws10" align="left">
        No has puesto la FECHA de Baneao para el USUARIO!<p>
        <a href="./?sw_administracion=baneos" class="style4">Volver a Administracion de Baneos!</a>
        </div>';
    }elseif($_POST["duracion_ban"]==""){
        //== SI EL CAMPO REPORTE_POST ESTA VACIO MOSTRAMOS LO SIGUIENTE ==//
        echo '<div class="ws10" align="left">
        No has puesto la Duracion del Baneo para el USUARIO!<p>
        <a href="./?sw_administracion=baneos" class="style4">Volver a Administracion de Baneos!</a>
        </div>';
    }else{
        //==== SI NO HAY ESPACIOS EN BLANCO LOS INSERTAMOS EN LA BASE DE DATOS ==//
        $sSQL="INSERT into baneos(id,motivo_ban,fecha_de_baneo,duracion_de_ban) 
        values('$_POST[id_us_b]','$_POST[motivo_ban]','$_POST[fecha_de_ban]','$_POST[duracion_ban]')";
        mysql_query($sSQL); 
        echo'<div class="ws10" align="left">
        El Baneo se ha agregado con exito!<p>
        <a href="./?sw_administracion=baneos" class="style4">Volver a Administracion de Baneos!</a>
        </div>';
    }
}else{
