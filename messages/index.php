...
<HEAD>
    <TITLE><?php echo 'Mensajes - '.$nombredelsitio;?></TITLE>
    ...
    <div id="sw_cabezera_envoltura">
        ...
        <div id="juniorsfriends_content">
            ...
            if(!isset($_SESSION[usuario]) ){
                ...
                <td><a href="enviar_ms.php" class="style7"><b>Enviar Mensaje</b></a></td>
                </tr>
                </table>
                <hr color="#CCCCCC" />';
                ...
                $ssql_n1 = "Select * from usuarios_messages where para_usuario='$_SESSION[idusuario]' ORDER BY fecha_de_message DESC";
                $rs_n1 = mysql_query($ssql_n1);
                while ($fila_n1 = mysql_fetch_array($rs_n1)){
                    ...
                    $ssql_n2 = "Select * from usuarios, usuarios_messages where usuarios_messages.de_usuario = usuarios.id and usuarios_messages.id_message='$id_notif'";
                    ...
                    <td><font color="royalblue"><b>'.$de_usuario.'</b></font> <font color="#222222" class="ws10"> | <i>'.$meesage_cortado .'</i> </font></td>
                    ...
                    <td>
                    <div align="right">
                    <a href="message.php?id_message='.$id_notif.'" class="style7"><b>Leer</b></a>
                    </div>
                    </td>
                    <tr>
                    </table>
