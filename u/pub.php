            ...
            <div style="margin-bottom:10px;"></div>
                <div class="<?php echo $Sidebar_izquierdo; ?>" id="juniorsfriends_sidebar">
                    ...
                    if(!isset($_SESSION[usuario]) ){
                        ...
                        echo '<a href="./'.$USUARIO_POST.'"><div id="imagen_perfil_usuario"><img src="../'.$VAR_MOSTRAR_AVATAR_u.'" width="229" border="0"/></div></a>';
                    ...
                    <a href="#"><img src="../imagenes/ic_perfil.png" border="0" width="15"> Perfil</a>';
                    //echo '<a href="../fotos/'.$USUARIO_POST.'"><img src="../imagenes/ic_fotos.png" border="0" width="15"> Fotos</a>';
                    
                    // CONTAMOS LOS POST QUE HA PUBLICADO EL USUARIO QUE SE ESTA MOSTRANDO //
                    $totaldeposts=mysql_query("select count(*) as TOTAL from posts WHERE id=$ID_USUARIO_POST");
                    $tot_post=mysql_fetch_array($totaldeposts);
                    //echo '<a href="../posts/'.$USUARIO_POST.'"><img src="../imagenes/ic_posts.png" border="0" width="15"> '.$tot_post['TOTAL'].' Posts</a>';
            ...
            if(!isset($_SESSION[usuario]) ){
                ...
                <table class="error_ver_perfil" width="100%">
                    <tr>
                        ...
                        <p>[<b><a href="../sw_login.php#myform_form_log" class="style8">Logueate</a></b>] o [<b><a href="../#myform_form_reg" class="style8">Registrate</a></b>]</p>
                        </td>
                    </tr>
                </table>';
            }else{
                if($_SESSION[login] == 1){
                    ...
                    echo '<table width="100%" border="0">
                        <tr>
                            <td>
                            <div align="left"><font class="style_text6">'.$USUARIO_POST.'</font> '.$NOMBRE_POST_USUARIO.'</div>
                            </td>
                    ...
                    if($ID_USUARIO_POST == $_SESSION[idusuario]){
                        //echo 'Este es mi perfil';
                        include ('./bl_menu_central_us.php');
                    ...
                    if($ID_USUARIO_POST == $_SESSION[idusuario]){
                        ...
                        <a href="../editcuenta/?editar_cuenta=datos_del_usuario"><img src="../imagenes/ic_edit_img.png" border="0" width="15">Actualizar Mi Perfil</a>
                        <p></div>';
