	...
	$.extend(F, {
		...
		defaults: {
			...
			tpl: {
				...
				error: '<p class="fancybox-error">The requested content cannot be loaded.<br/>Porfavor, inténtelo más tarde</p>',
				closeBtn: '<div title="Cerrar" class="fancybox-item fancybox-close"></div>',
				next: '<a title="Siguente" class="fancybox-item fancybox-next"><span></span></a>',
