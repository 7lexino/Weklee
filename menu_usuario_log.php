...
if($estadoUsuario == 1){
    ...
    if($fila_us_on = mysql_fetch_array($rs_us_on)){
        ...
        if(file_exists($avatar_us_am_m)){
            $VAR_MOSTRAR_AVATAR_m = $avatar_us_am_m;
        }else{
            $VAR_MOSTRAR_AVATAR_m = "imagenes/img_sin_avatar.jpg";
        }
    }
}
?>
...
$(document).ready(function() {
        $("#load_menu_not").load("sw_notif.php");
  var refreshId = setInterval(function() {
     $("#load_menu_not").load('./sw_notif.php?randval='+ Math.random());
  }, 19000);
...
<script>
$(document).ready(function() {
        $("#load_not").load("bl_mostrar_notificaciones.php");
  var refreshId = setInterval(function() {
     $("#load_not").load('./bl_mostrar_notificaciones.php?randval='+ Math.random());
  }, 19000);
  $.ajaxSetup({ cache: false });
});
</script>
<div class="contenido_menu_top">
    ...
    <li><a href="./" title="Inicio"><img src="./<?php echo $logotipodelsitio; ?>"  height="31" border="0"/></a></li>
        ...
        <div style="width: 330px; float: left; margin-left: 40px; margin-top: 0px;">
            <?PHP include('sw_buscador.php'); ?>
        </div>
    ...
    if($estadoUsuario == 1)
    {
        ...
        <img width="34px" src="<?php echo $VAR_MOSTRAR_AVATAR_m; ?>"></div></a>
        <div id="miDiv">
...
echo'</div></div>';
        ...
        echo '<li>
        <a href="./wek_register.php" title="Registro">
        <div class="left_posts"><img src="./imagenes/ic_sign-up.png" width="30" height="30" border="0" /></div>
        <div class="right_menu_top"> Registrarse</div></a>
        </li>';
        
        echo '<li>
        <a href="./wek_login.php" title="Iniciar Sesion">
